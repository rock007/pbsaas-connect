package com.pbsaas.connect.framework.dao.sql.template.engines;

import com.pbsaas.connect.framework.dao.sql.template.SqlResult;
import com.pbsaas.connect.framework.dao.sql.template.SqlTemplate;
import com.pbsaas.connect.framework.dao.sql.template.SqlTemplateEngine;
...
public abstract class PreparedSqlTemplateEngine<T> implements SqlTemplateEngine {
    ...
    protected Logger logger = LoggerFactory.getLogger(PreparedSqlTemplateEngine.class);
