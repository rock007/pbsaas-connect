...
import com.pbsaas.connect.core.model.PageBody;
import com.pbsaas.connect.framework.dao.Dao;
import com.pbsaas.connect.framework.dao.RowMapper;
...
public class JpaDao implements Dao {
    ...
    @Override
    public PageBody<Object[]> queryPage(String sqlId, Map<String, Object> params, int pageNum, int pageSize) {
        SqlResult rs = SqlTemplateManager.getSqlResult(sqlId, params);
        return this.queryPageBySql(rs.getSql(), rs.getParamMap(), pageNum, pageSize);
    }

    @Override
    public <T extends Serializable> PageBody<T> queryPage(String sqlId, Map<String, Object> params, Class<T> clazz, int pageNum, int pageSize) {
        SqlResult rs = SqlTemplateManager.getSqlResult(sqlId, params);
        return this.queryPageBySql(rs.getSql(), rs.getParamMap(), clazz, pageNum, pageSize);
    }

    @Override
    public <T extends Serializable> PageBody<T> queryPage(String sqlId, Map<String, Object> params, RowMapper<T> mapper, int pageNum, int pageSize) {
        SqlResult rs = SqlTemplateManager.getSqlResult(sqlId, params);
    ...
    @Override
    public PageBody<Object[]> queryPageBySql(String sql, Map<String, Object> params, int pageNum, int pageSize) {
    ...
    @Override
    public <T extends Serializable> PageBody<T> queryPageBySql(String sql, Map<String, Object> params, final Class<T> clazz, int pageNum, int pageSize) {
    ...
    @Override
    public <T extends Serializable> PageBody<T> queryPageBySql(String sql, Map<String, Object> params, final RowMapper<T> mapper, int pageNum, int pageSize) {
        return this.queryPageBySql(sql, params, pageNum, pageSize, new QueryRunner<T>() {
            @Override
            public List<T> query(String sql, Map<String, Object> params) {
     ...
     */
    private <T extends Serializable> PageBody<T> queryPageBySql(String sql, Map<String, Object> params, int pageNum, int pageSize, QueryRunner<T> runner) {
