...
public interface Dao {
     ...
     */
    PageModel<Object[]> queryPage(String sqlId, Map<String, Object> params, int pageNum, int pageSize);

    /**
     * 根据sqlId分页查询（sql保存在xml配置文件中，根据sqlId查找对应的sql语句）
     */
    <T extends Serializable> PageModel<T> queryPage(String sqlId, Map<String, Object> params, Class<T> clazz, int pageNum, int pageSize);

    /**
     * 根据sqlId分页查询（sql保存在xml配置文件中，根据sqlId查找对应的sql语句）
     */
    <T extends Serializable> PageModel<T> queryPage(String sqlId, Map<String, Object> params, RowMapper<T> mapper, int pageNum, int pageSize);
     ...
     * 根据sql语句分页查询
     */
    PageModel<Object[]> queryPageBySql(String sql, Map<String, Object> params, int pageNum, int pageSize);

    /**
     * 根据sql语句分页查询
     */
    <T extends Serializable> PageModel<T> queryPageBySql(String sql, Map<String, Object> params, Class<T> clazz, int pageNum, int pageSize);

    /**
     * 根据sql语句分页查询
     */
    <T extends Serializable> PageModel<T> queryPageBySql(String sql, Map<String, Object> params, RowMapper<T> mapper, int pageNum, int pageSize);
