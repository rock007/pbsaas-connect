package com.pbsaas.connect.db.dao.impl;

import com.pbsaas.connect.db.dao.Dao;
import com.pbsaas.connect.db.dao.RowMapper;
import com.pbsaas.connect.db.dao.sql.support.SqlSupport;
import com.pbsaas.connect.db.dao.sql.support.SqlSupportFactory;
import com.pbsaas.connect.db.dao.sql.template.SqlResult;
import com.pbsaas.connect.db.dao.sql.template.SqlTemplateManager;
import com.pbsaas.connect.db.model.PageModel;
...
public class JpaDao implements Dao {
    ...
    @Override
    public PageModel<Object[]> queryPage(String sqlId, Map<String, Object> params, int pageNum, int pageSize) {
        SqlResult rs = SqlTemplateManager.getSqlResult(sqlId, params);
        return this.queryPageBySql(rs.getSql(), rs.getParamMap(), pageNum, pageSize);
    }

    @Override
    public <T extends Serializable> PageModel<T> queryPage(String sqlId, Map<String, Object> params, Class<T> clazz, int pageNum, int pageSize) {
        SqlResult rs = SqlTemplateManager.getSqlResult(sqlId, params);
        return this.queryPageBySql(rs.getSql(), rs.getParamMap(), clazz, pageNum, pageSize);
    }

    @Override
    public <T extends Serializable> PageModel<T> queryPage(String sqlId, Map<String, Object> params, RowMapper<T> mapper, int pageNum, int pageSize) {
        SqlResult rs = SqlTemplateManager.getSqlResult(sqlId, params);
    ...
    @Override
    public PageModel<Object[]> queryPageBySql(String sql, Map<String, Object> params, int pageNum, int pageSize) {
    ...
    @Override
    public <T extends Serializable> PageModel<T> queryPageBySql(String sql, Map<String, Object> params, final Class<T> clazz, int pageNum, int pageSize) {
    ...
    @Override
    public <T extends Serializable> PageModel<T> queryPageBySql(String sql, Map<String, Object> params, final RowMapper<T> mapper, int pageNum, int pageSize) {
        return this.queryPageBySql(sql, params, pageNum, pageSize, new QueryRunner<T>() {
            @Override
            public List<T> query(String sql, Map<String, Object> params) {
     ...
     */
    private <T extends Serializable> PageModel<T> queryPageBySql(String sql, Map<String, Object> params, int pageNum, int pageSize, QueryRunner<T> runner) {
